...
function buildExtractPrompt(noteText: string): string {
  return `以下のメモから、深掘りする価値のある人物名・キーワード・概念・書籍・ツール名を最大8個抽出してください。

メモ:
${noteText}

必ず以下のJSON形式のみで返してください（typeは person/keyword/book/tool のいずれか）:
